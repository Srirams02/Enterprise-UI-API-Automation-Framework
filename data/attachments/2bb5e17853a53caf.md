...
+   
+
+   AdminPIMLeaveTimeRecruitmentMy InfoPerformanceDashboardDirectoryMaintenanceClaimBuzzPIM UpgradePiyush rajConfiguration Employee ListAdd EmployeeReportsAdd EmployeeAccepts jpg, .png, .gif up to 1MB. Recommended dimensions: 200px X 200pxEmployee Full NameEmployee IdCreate Login Details * Required Cancel  Save OrangeHRM OS 5.8© 2005 - 2026 OrangeHRM, Inc. All rights reserved.
+   
+   
+   
+
